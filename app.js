...
const BEER_DATA = {
  belgian: {
    ...
    ibu: "12",
    temp: "4-6°C",
    desc: "Pale, cloudy and gently spiced with orange peel, coriander and chamomile. Bright carbonation lifts the citrus finish, making this Flow's most refreshing wheat pour.",
    pairings: "Tandoori Prawns, Fish Tikka, Avo & Beet, and Crunchy Thai Tofu Bao. Citrus, herbs and carbonation cut through spice and seafood richness.",
  ...
  german: {
    ...
    ibu: "10",
    temp: "5-7°C",
    desc: "A classic Bavarian-style wheat beer with a naturally cloudy pour, silky mouthfeel and lively banana-clove aromatics. Light, effervescent and incredibly easy to sip.",
    pairings: "Black & White Charred Chicken, Basil Chicken Sui Mai, Podi Idli Fries, and Apple & Cheese. The beer's clove, banana and bubbles work well with char, spice and gentle sweetness.",
  ...
  mango: {
    ...
    pairings: "Korean Fried Chicken, Sri Lankan Style Devilled Paneer, Thai Curry, and Tandoori Prawns. Mango sweetness cools chilli while lager carbonation resets the palate.",
  ...
  joey: {
    ...
    pairings: "Beer Battered Fish & Chips, Margherita, Naples Style Garlic Bread, and Parmesan Truffle Fries. Clean malt and moderate bitterness flatter salt, dough and fried crunch.",
  ...
  neipa: {
    ...
    pairings: "Pork Charsui Bao, Korean Fried Chicken, Baja Fish Tacos, and Queso & Avo Mole. Hazy hops echo tropical spice and cut through fat without harsh bitterness.",
  ...
  stout: {
    ...
    ibu: "30",
    temp: "10-12°C",
    desc: "Rich and velvety stout poured on nitro for a creamy cascading head, smooth roasted malts, subtle chocolate and a silky finish.",
    pairings: "Tenderloin Steak, Slow Braised BBQ Pork Belly, Baked Chocolate Cheesecake, and Irish Coffee Cheesecake. Roast, chocolate and nitro texture match char, smoke and cocoa.",
  ...
  cider: {
    ...
    ibu: "NA",
    temp: "4-5°C",
    desc: "Clean, crisp hard cider with an amber appearance, tangy-tart sweetness and fruity aroma from pressed Kashmiri apples.",
    pairings: "Pork Charsui Bao, Caper Butter Grilled Fish, Pesto Burrata, and Apple & Cheese. Apple acidity cuts cream and pork richness while complementing fruit and brie.",
  ...
  mead: {
    ...
    pairings: "Seekh Kebab Platter, Rose Harissa Paneer Tikka, Blue Cheese Naan, and Classic Tiramisu. Honeyed sweetness softens spice and plays well with blue cheese, coffee and cream.",
